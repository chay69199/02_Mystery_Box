...
class Start:
    def __init__(self, parent):
        ...
        # Entry box...(row 1)
        self.start_amount_entry = Entry(self.stakes_frame, font="Arial 16 bold")
        self.start_amount_entry.get(row=2)
       ...
       # Initial Instructions (row 1)
        self.mystery_instructions = Label(self.start_frame,
                                         ...
                                         text="Please enter a dollar amount "
                                              ...
                                              "thr more you can win!",
                                         wrap=275, justify=LEFT, padx =10, pady= 200)
        ...
        self.amount_error_label = Label(self.entry_error_frame, fg="maroon",
                                        ...
                                        justify=LEFT)
        self.amount_error_label.grid(row=1, columnspan=2, psdy=5)
        ...
        self.medium_stakes_button = Button(self.stakes_frame,
                                           ...
                                           font=button_font, bg="#FFFF333")
        self.high_stakes_button.grid(row=0, column=2, pady=10)

        # Green.high_stakes button...
        ...
        # Help Button
        self.high_stakes_button = Button(self.stakes_frame, text="How to Play",
    ...
    def check_funds(self):
        ...
        # Set error background colours (add assume that there are no)
        # error at the start...
        error_back = "#ffafaf"
        has_errors = "no"
        ...
        try:
            ...
            has_errors = "yes"
            error_feedback = "Please enter a dollar amount (to text / decimals)"
...
class Game:
    def __int__(self, partner,stakes,starting_balance):
      ...
      partner.lowstskes_button.config(state=DISABLED)
